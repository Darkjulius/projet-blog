...
<body class="antialiased">
  ...
  <div class="md:container mx-auto md:px-6 lg:px-8 grid md:grid-cols-2 xl:grid-cols-3 gap-y-12 md:gap-x-8 pb-16 md:pt-16">
    <article>
      <img src="img/blue.png" alt="blue.png" class="w-full">
    ...
    <article>
      <img src="img/notes.png" alt="notes.png" class="w-full">
      <div class="px-4 sm:px-6 md:px-0">
        <h1 class="mt-4 text-2xl sm:text-3xl md:text-2xl font-bold text-gray-900">
          Lorem ipsum dolor sit amet consectetur adipisicing.
        </h1>
    ...
    <article>
      <img src="img/pancakes.png" alt="pancakes.png" class="w-full">
      <div class="px-4 sm:px-6 md:px-0">
        <h1 class="mt-4 text-2xl sm:text-3xl md:text-2xl font-bold text-gray-900">
          Lorem ipsum dolor sit amet consectetur adipisicing.
        </h1>
    ...
    <article>
      <img src="img/bikes.png" alt="bikes.png" class="w-full">
      <div class="px-4 sm:px-6 md:px-0">
        <h1 class="mt-4 text-2xl sm:text-3xl md:text-2xl font-bold text-gray-900">
          Lorem ipsum dolor sit amet consectetur adipisicing.
        </h1>
